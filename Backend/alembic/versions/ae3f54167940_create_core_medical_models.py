"""create core medical models

Revision ID: ae3f54167940
Revises: 
Create Date: 2025-11-23 16:37:21.256415
...
def upgrade() -> None:
    ...
    sa.Column('heatmap_base64', sa.Text(), nullable=False),
